                    ...
                    <div class="card-form">
                        <form class="form-horizontal" action="" method="POST" onsubmit="return checkPlanDetails(this);" autocomplete="off">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label>Stocks or Bonds? </label>
                                    <input name="txt_goalname" type="text" class="form-control margin-bottom" placeholder="" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group btn-input clearfix margin-bottom">
                                        <button type="button" class="btn btn-transparent dropdown-toggle form-control" data-toggle="dropdown">
                                            <span data-bind="label">Select investments priority</span><span class="caret"></span>
                                        </button>
